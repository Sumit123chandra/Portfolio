...
>
  ...
  />
      ...
      >
        Hi! I’m <span className="text-purple-400 font-semibold">Sumit Chandra</span>, 
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
        <a href="/resume.pdf" download="Sumit_Chandra_Resume.pdf" className="px-6 py-3 bg-purple-500 hover:bg-purple-600 rounded-full text-white font-medium shadow-lg transition">
          📄 Download Resume
        </a>
...
<section id="achievements" className="relative z-10 py-20 px-6 md:px-20 bg-gray-900">
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {[
        { title: "🥉 Hackathon Winner", desc: "3rd Place at NSUT Shlokacode Hackathon", icon: "🏆" },
        { title: "Projects", desc: "Built multiple full-stack web apps & personal projects", icon: "💻" },
        { title: "🛠 Internship", desc: "Completed two 1-month Web Dev Internship at Cantilever.in", icon: "🚀" }
      ].map((ach, index) => (
        <motion.div
          key={index}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {[
          ...
          },
          {
            ...
            github: "https://github.com/Sumit123chandra/e_commerce_site",
            live: "https://github.com/Sumit123chandra/e_commerce_site"
          },
          {
            title: "Task Manager",
            img: taskManagerImg,
  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    <div className="bg-gray-800/50 backdrop-blur-md p-6 rounded-xl shadow-lg max-w-lg mx-auto mb-8">
      <p className="text-gray-300 text-lg">
        📧 Email:{" "}
        <a
          href="mailto:chandra78.sumit1@gmail.com?subject=Hello Sumit&body=I saw your portfolio and..."
    ...
    <div className="flex justify-center gap-8 mt-6 text-4xl">
      ...
      {/* 📍 Location */}
      <p className="text-gray-300 text-lg mt-2">
        📍 Location: <span className="text-purple-400">Najafgarh, New Delhi, India</span>
      </p>
  </div>
</section>
